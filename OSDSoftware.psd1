...
ModuleVersion = '19.2.19.0'

# Supported PSEditions
# CompatiblePSEditions = @()

# ID used to uniquely identify this module
GUID = '58261a42-44a3-4c14-aa5a-542533b68677'
...
FunctionsToExport = 'Get-OSDSoftware','Update-ModuleOSDSoftware'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://www.osdeploy.com/osdsoftware/home'

        # A URL to an icon representing this module.
        # IconUri = ''

        # ReleaseNotes of this module
        ReleaseNotes = 'https://www.osdeploy.com/osdsoftware/releases'
